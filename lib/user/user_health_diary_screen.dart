import 'dart:convert';
import 'dart:io';
// import 'package:animal_project/user/user_diary_add_screen.dart'; // 파일이 없으므로 임시 주석 처리
import 'package:animal_project/user/user_diary_add_screen.dart';
import 'package:animal_project/user/user_diary_detail_screen.dart';
import 'package:animal_project/user/user_health_main.dart' hide kPrimaryColor;
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:intl/intl.dart';

import '../models/user_health_models.dart'; // ✅ 올바른 경로
